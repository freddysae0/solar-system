...
const TEX = {
  Sun:     { map: loadTex('/src/assets/2k_sun.jpg') },
  Mercury: { map: loadTex('/src/assets/2k_mercury.jpg') },
  Venus:   { map: loadTex('/src/assets/2k_venus_surface.jpg') },
  Earth: {
    day:    loadTex('/src/assets/2k_earth_daymap.jpg'),
    night:  loadTex('/src/assets/2k_earth_nightmap.jpg'),
    clouds: loadTex('/src/assets/2k_earth_clouds.jpg', false),
  },
  Mars:    { map: loadTex('/src/assets/2k_mars.jpg') },
  Jupiter: { map: loadTex('/src/assets/2k_jupiter.jpg') },
  Saturn:  {
    map:       loadTex('/src/assets/2k_saturn.jpg'),
    ringAlpha: loadTex('/src/assets/2k_saturn_ring_alpha.png', false),
  },
  Uranus:  { map: loadTex('/src/assets/2k_uranus.jpg') },
  Neptune: { map: loadTex('/src/assets/2k_neptune.jpg') },
};
